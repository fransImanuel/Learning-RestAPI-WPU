...
$result = get_CURL('Https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyDDaVPjPsm6xDwuBdurwbH1EhFzOjFango');
...
// latest video
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyDDaVPjPsm6xDwuBdurwbH1EhFzOjFango&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResults=1&order=date&part=snippet';
$result = get_CURL($urlLatestVideo);
$latestVideoId = $result["items"][0]["id"]["videoId"];
var_dump($latestVideoId);
      ...
      <div class="row justify-content-center">
        <div class="col-md-5">
          <div class="row mt-3 pb-3">
            <div class="col-md-4">
              <img src="<?= $youtubeProfilePicture; ?>" class="rounded-circle img-thumbnail" width="200">
            </div>
            <div class="col-md-8">
              <h5><?= $channelName ?></h5>
              <p><?= $subscriber ?> Subsriber</p>
